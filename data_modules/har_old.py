...
class HarDataModule(L.LightningDataModule):
    ...
    def train_dataloader(self):
        dataloader = self._get_dataset_dataloader(self.root_data_dir / "train.csv", shuffle=True) 
        return dataloader
    
    def val_dataloader(self):
        dataloader = self._get_dataset_dataloader(self.root_data_dir / "validation.csv", shuffle=False) 
        return dataloader
    
    def test_dataloader(self):
        dataloader = self._get_dataset_dataloader(self.root_data_dir / "test.csv", shuffle=False) 
        return dataloader
